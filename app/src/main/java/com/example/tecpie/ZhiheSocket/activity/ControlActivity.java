...
import com.example.tecpie.ZhiheSocket.pojo.App_request_execute;
import com.example.tecpie.ZhiheSocket.pojo.Control;
import com.example.tecpie.ZhiheSocket.pojo.ControlBean;
import com.example.tecpie.ZhiheSocket.pojo.StateBean;
import com.example.tecpie.ZhiheSocket.utils.HonyarWebServiceUtil;
...
//                    "}";
        ...
        public void fh() {
            ...
            intent.putExtra("deviceId",deviceId);
            intent.putExtra("endpointid",endpointid);
            intent.setClass(ControlActivity.this, DetailActivity.class);
            startActivity(intent);
        }
