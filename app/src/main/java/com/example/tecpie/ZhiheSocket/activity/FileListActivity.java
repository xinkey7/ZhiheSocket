...
import com.example.tecpie.ZhiheSocket.entity.FileEntity;
import com.example.tecpie.ZhiheSocket.entity.FileEntity.Type;
                ...
                if(entity.getFileType() == Type.FLODER){
                    ...
                    runOnUiThread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            editor.putString("readpath",entity.getFilePath());
                            editor.commit();*/
                            Intent data = new Intent();
                            data.putExtra("path", entity.getFilePath());
                         /*   Toast.makeText(mContext, entity.getFilePath(),
